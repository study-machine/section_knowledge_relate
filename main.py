...
class FlushSectionKnowledge(object):
    ...
    def run(self):
        for section in self.section_list:
            ...
            self.get_section_knowledge_id_list(section.CourseSectionID, section_knowledge_id_list)
    ...
    def get_section_knowledge_id_list(self, section_id, section_knowledge_id_list):
        ...
        for question in questions:
            ...
            knowledges = Knowledge.get_knowledge_by_q_id(question.QuestionID)
            question_knowledge_id_list = [k.KnowID for k in knowledges]
    ...
    def write_relate_section_knowledge(self, section, k_id_set):
        ...
        for k_id in k_id_list:
            ...
            log_text = 'Insert into relate section_id:{} and know_id:{}'.format(section.CourseSectionID, k_id)
            log.info(log_text)
            print log_text
            self.count += 1
